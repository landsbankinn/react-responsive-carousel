...
Carousel.propTypes = {
    ...
    sliderOffset: _propTypes2.default.number
};
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.setPosition = function (position, forceReflow) {
        var list = _reactDom2.default.findDOMNode(_this5.listRef);['WebkitTransform', 'MozTransform', 'MsTransform', 'OTransform', 'transform', 'msTransform'].forEach(function (prop) {
